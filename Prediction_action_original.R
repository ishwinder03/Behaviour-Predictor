...
# ^ This is clear (maybe) by slide 7 in 3-3-22 Internal Psychograhcis data 
# Define the path to your Documents folder  
documents_path <- "C:/Users/acollins056/OneDrive - PwC/Documents"  
...
# Need the columns to be idential
